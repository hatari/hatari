...
*/
char IoMemTables_rcsid[] = "Hatari $Id: ioMemTables.c,v 1.1 2005-01-31 22:15:46 thothy Exp $";
...
INTERCEPT_ACCESS_FUNC IoMemTable_ST[] =
{
	...
	{ 0xff820b, SIZE_BYTE, IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus error here */
	...
	{ 0xff8261, 31,        IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus errors here */
	...
	{ 0xff860f, SIZE_BYTE, IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus error here */
	...
	{ 0xfffa31, SIZE_BYTE, IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus error here */
	{ 0xfffa33, SIZE_BYTE, IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus error here */
	{ 0xfffa35, SIZE_BYTE, IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus error here */
	{ 0xfffa37, SIZE_BYTE, IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus error here */
	{ 0xfffa39, SIZE_BYTE, IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus error here */
	{ 0xfffa3b, SIZE_BYTE, IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus error here */
	{ 0xfffa3d, SIZE_BYTE, IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus error here */
	{ 0xfffa3f, SIZE_BYTE, IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus error here */

	{ 0xfffc00, SIZE_BYTE, IKBD_KeyboardControl_ReadByte, IKBD_KeyboardControl_WriteByte },
	{ 0xfffc01, SIZE_BYTE, IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus error here */
	{ 0xfffc02, SIZE_BYTE, IKBD_KeyboardData_ReadByte, IKBD_KeyboardData_WriteByte },
	{ 0xfffc03, SIZE_BYTE, IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus error here */
	{ 0xfffc04, SIZE_BYTE, Midi_Control_ReadByte, Midi_Control_WriteByte },
	{ 0xfffc05, SIZE_BYTE, IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus error here */
	{ 0xfffc06, SIZE_BYTE, Midi_Data_ReadByte, Midi_Data_WriteByte },
	{ 0xfffc07, 505,       IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus errors here */
...
INTERCEPT_ACCESS_FUNC IoMemTable_MegaST[] =
{
	...
	{ 0xfffc05, SIZE_BYTE, IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus error here */
	{ 0xfffc06, SIZE_BYTE, Midi_Data_ReadByte, Midi_Data_WriteByte },
	{ 0xfffc07, 26,        IoMem_ReadWithoutInterception, IoMem_WriteWithoutInterception }, /* No bus errors here (?) */
