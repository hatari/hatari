...
*/
const char MemorySnapShot_rcsid[] = "Hatari $Id: memorySnapShot.c,v 1.43 2008-11-29 11:29:50 thothy Exp $";
...
#define VERSION_STRING      "1.1.0"   /* Version number of compatible memory snapshots - Always 6 bytes (inc' NULL) */
