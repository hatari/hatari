...
*/
char MemorySnapShot_rcsid[] = "Hatari $Id: memorySnapShot.c,v 1.17 2005-09-13 01:10:09 thothy Exp $";
...
#define VERSION_STRING      "0.72 "   /* Version number of compatible memory snapshots - Always 6 bytes (inc' NULL) */
