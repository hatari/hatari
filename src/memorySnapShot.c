...
*/
const char MemorySnapShot_rcsid[] = "Hatari $Id: memorySnapShot.c,v 1.22 2006-02-08 22:51:22 eerot Exp $";
...
#define VERSION_STRING      "0.82 "   /* Version number of compatible memory snapshots - Always 6 bytes (inc' NULL) */
