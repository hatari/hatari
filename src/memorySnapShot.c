...
*/
const char MemorySnapShot_rcsid[] = "Hatari $Id: memorySnapShot.c,v 1.26 2006-10-03 10:07:52 thothy Exp $";
...
#define VERSION_STRING      "0.91 "   /* Version number of compatible memory snapshots - Always 6 bytes (inc' NULL) */
