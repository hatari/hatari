...
*/
char MemorySnapShot_rcsid[] = "Hatari $Id: memorySnapShot.c,v 1.18 2005-10-04 15:31:52 thothy Exp $";
...
#define VERSION_STRING      "0.73 "   /* Version number of compatible memory snapshots - Always 6 bytes (inc' NULL) */
