...
*/
char MemorySnapShot_rcsid[] = "Hatari $Id: memorySnapShot.c,v 1.19 2005-10-12 09:06:47 thothy Exp $";
...
#define VERSION_STRING      "0.80 "   /* Version number of compatible memory snapshots - Always 6 bytes (inc' NULL) */
