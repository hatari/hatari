...
*/
const char MemorySnapShot_rcsid[] = "Hatari $Id: memorySnapShot.c,v 1.31 2007-11-19 21:19:02 thothy Exp $";
...
#define VERSION_STRING      "0.96 "   /* Version number of compatible memory snapshots - Always 6 bytes (inc' NULL) */
