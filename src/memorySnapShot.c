...
*/
const char MemorySnapShot_rcsid[] = "Hatari $Id: memorySnapShot.c,v 1.24 2006-07-11 18:52:18 thothy Exp $";
...
#define VERSION_STRING      "0.83 "   /* Version number of compatible memory snapshots - Always 6 bytes (inc' NULL) */
