...
*/
const char MemorySnapShot_rcsid[] = "Hatari $Id: memorySnapShot.c,v 1.30 2007-05-12 11:08:20 thothy Exp $";
...
#define VERSION_STRING      "0.95 "   /* Version number of compatible memory snapshots - Always 6 bytes (inc' NULL) */
