...
*/
const char MemorySnapShot_rcsid[] = "Hatari $Id: memorySnapShot.c,v 1.25 2006-08-22 18:39:23 thothy Exp $";
...
#define VERSION_STRING      "0.90 "   /* Version number of compatible memory snapshots - Always 6 bytes (inc' NULL) */
