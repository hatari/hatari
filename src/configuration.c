...
*/
const char Configuration_rcsid[] = "Hatari $Id: configuration.c,v 1.93 2008-08-12 19:40:43 eerot Exp $";
...
static const struct Config_Tag configs_ShortCutWithMod[] =
{
	...
	{ "keyDebug",      Int_Tag, &ConfigureParams.Shortcut.withModifier[SHORTCUT_DEBUG] },
...
static const struct Config_Tag configs_ShortCutWithoutMod[] =
{
	...
	{ "keyDebug",      Int_Tag, &ConfigureParams.Shortcut.withoutModifier[SHORTCUT_DEBUG] },
...
void Configuration_SetDefault(void)
{
	...
	ConfigureParams.Shortcut.withoutModifier[SHORTCUT_DEBUG] = SDLK_PAUSE;
