...
extern BOOL File_OpenDlg(/*HWND hWnd,*/ char *pFullFileName,int Drive);
...
extern BOOL File_OpenSelectDlg(/*HWND hWnd,*/ char *pFullFileName,int FileFilter,BOOL bFileMustExist,BOOL bSaving);
...
extern char *File_GetFileNameDrive(char *pszFileName);
...
extern void File_GetDirectoryString(char *pszFileName, char *pszDirName);
...
extern BOOL File_Save(/*HWND hWnd,*/char *pszFileName, void *pAddress,long Size,BOOL bQueryOverwrite);
extern int File_Length(char *pszFileName);
extern BOOL File_Exists(char *pszFileName);
extern BOOL File_Delete(char *pszFileName);
extern BOOL File_QueryOverwrite(/*HWND hWnd,*/char *pszFileName);
