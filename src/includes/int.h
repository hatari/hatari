...
extern void Int_AddAbsoluteInterrupt(Sint64 CycleTime, int CycleType, interrupt_id Handler);
extern void Int_AddRelativeInterrupt(Sint64 CycleTime, int CycleType, interrupt_id Handler);
extern void Int_AddRelativeInterruptNoOffset(Sint64 CycleTime, int CycleType, interrupt_id Handler);
extern void Int_AddRelativeInterruptWithOffset(Sint64 CycleTime, int CycleType, interrupt_id Handler, int CycleOffset);
