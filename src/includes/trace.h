...
#define	HATARI_TRACE_MFP_EXCEPTION	(1<<8)
#define	HATARI_TRACE_MFP_START		(1<<9)
#define	HATARI_TRACE_MFP_READ		(1<<10)

#define	HATARI_TRACE_PSG_WRITE_REG	(1<<11)
#define	HATARI_TRACE_PSG_WRITE_DATA	(1<<12)

#define	HATARI_TRACE_CPU_PAIRING	(1<<13)
#define	HATARI_TRACE_CPU_DISASM		(1<<14)
#define	HATARI_TRACE_CPU_EXCEPTION	(1<<15)

#define	HATARI_TRACE_INT		(1<<16)

#define	HATARI_TRACE_FDC		(1<<17)

#define	HATARI_TRACE_IKBD		(1<<18)
...
#define	HATARI_TRACE_VIDEO_ALL		( HATARI_TRACE_VIDEO_SYNC | HATARI_TRACE_VIDEO_RES | HATARI_TRACE_VIDEO_COLOR \
		...
		| HATARI_TRACE_VIDEO_VBL | HATARI_TRACE_VIDEO_HBL )
