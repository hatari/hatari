/*
  ...
  Tables for cycles when allow top/bottom borders. Also left/right and Sync Scroll
*/

//-----------------------------------------------------------------------
// Top/Bottom Border tables - NOTE due to natural interrupt inaccuracies(ie interrupt due while
// currently processing instruction) these values have a 'range' - We have a single table
// entry for each possible + overlap, just in-case!
