...
/*1800*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// MMUOP030.L (An),#<data>.W
/*1801*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// MMUOP030.L (d16,An),#<data>.W
/*1802*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// MMUOP030.L (d8,An,Xn),#<data>.W
/*1803*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// MMUOP030.L (xxx).W,#<data>.W
/*1804*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// MMUOP030.L (xxx).L,#<data>.W
/*1805*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FPP.L #<data>.W,Dn
/*1806*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FPP.L #<data>.W,An
/*1807*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FPP.L #<data>.W,(An)
/*1808*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FPP.L #<data>.W,(An)+
/*1809*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FPP.L #<data>.W,-(An)
/*1810*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FPP.L #<data>.W,(d16,An)
/*1811*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FPP.L #<data>.W,(d8,An,Xn)
/*1812*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FPP.L #<data>.W,(xxx).W
/*1813*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FPP.L #<data>.W,(xxx).L
/*1814*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FPP.L #<data>.W,(d16,PC)
/*1815*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FPP.L #<data>.W,(d8,PC,Xn)
/*1816*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FPP.L #<data>.W,#<data>.L
/*1817*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FScc.L #<data>.W,Dn
/*1818*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FDBcc.L #<data>.W,Dn
/*1819*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FScc.L #<data>.W,(An)
/*1820*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FScc.L #<data>.W,(An)+
/*1821*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FScc.L #<data>.W,-(An)
/*1822*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FScc.L #<data>.W,(d16,An)
/*1823*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FScc.L #<data>.W,(d8,An,Xn)
/*1824*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FScc.L #<data>.W,(xxx).W
/*1825*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FScc.L #<data>.W,(xxx).L
/*1826*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FTRAPcc.L #<data>.W
/*1827*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FTRAPcc.L #<data>.L
/*1828*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FTRAPcc.L 
/*1829*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FBccQ.L #<data>,#<data>.W
/*1830*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FBccQ.L #<data>,#<data>.L
/*1831*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FSAVE.L (An)
/*1832*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FSAVE.L -(An)
/*1833*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FSAVE.L (d16,An)
/*1834*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FSAVE.L (d8,An,Xn)
/*1835*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FSAVE.L (xxx).W
/*1836*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FSAVE.L (xxx).L
/*1837*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FRESTORE.L (An)
/*1838*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FRESTORE.L (An)+
/*1839*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FRESTORE.L (d16,An)
/*1840*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FRESTORE.L (d8,An,Xn)
/*1841*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FRESTORE.L (xxx).W
/*1842*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FRESTORE.L (xxx).L
/*1843*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FRESTORE.L (d16,PC)
/*1844*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// FRESTORE.L (d8,PC,Xn)
/*1845*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// CINVLQ.L #<data>,An
/*1846*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// CINVPQ.L #<data>,An
/*1847*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// CINVAQ.L #<data>
/*1848*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// CINVAQ.L #<data>
...
/*1855*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// CPUSHLQ.L #<data>,An
/*1856*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// CPUSHPQ.L #<data>,An
/*1857*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// CPUSHAQ.L #<data>
/*1858*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// CPUSHAQ.L #<data>
...
/*1865*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// PFLUSHN.L (An)
/*1866*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// PFLUSH.L (An)
/*1867*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// PFLUSHAN.L (An)
/*1868*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// PFLUSHA.L (An)
/*1869*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// PTESTR.L (An)
/*1870*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// PTESTW.L (An)
/*1871*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// PLPAR.L (An)
/*1872*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// PLPAW.L (An)
/*1873*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// MOVE16.L (An)+,(xxx).L
/*1874*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// MOVE16.L (xxx).L,(An)+
/*1875*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// MOVE16.L (An),(xxx).L
/*1876*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// MOVE16.L (xxx).L,(An)
/*1877*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// MOVE16.L (An)+,(An)+
/*1878*/	{6,	0,	 20,0,1,0,	22,0,1,0},	// LPSTOP.L #<data>.W
/*1879*/	{0,	0,	 6,0,0,0,	 8,0,1,0},	// NBCD.B Dn	(value guessed (not in motorola 68030UM doc))
/*1880*/	{1,	1,	13,1,0,1,	15,1,1,1},	// NBCD.B (An)	(value guessed (not in motorola 68030UM doc))
/*1881*/	{0,	1,	13,1,0,1,	15,1,1,1},	// NBCD.B (An)+	(value guessed (not in motorola 68030UM doc))
/*1882*/	{2,	2,	14,1,0,1,	16,1,1,1},	// NBCD.B -(An)	(value guessed (not in motorola 68030UM doc))
/*1883*/	{2,	2,	14,1,0,1,	18,1,2,1},	// NBCD.B (d16,An)	(value guessed (not in motorola 68030UM doc))
/*1884*/	{4,	2,	16,1,0,1,	20,1,2,1},	// NBCD.B (d8,An,Xn)	(value guessed (not in motorola 68030UM doc))
/*1885*/	{2,	2,	14,1,0,1,	18,1,2,1},	// NBCD.B (xxx).W	(value guessed (not in motorola 68030UM doc))
/*1886*/	{1,	0,	14,1,0,1,	19,1,2,1},	// NBCD.B (xxx).L	(value guessed (not in motorola 68030UM doc))
/*1887*/	{0,	0,	 4,0,0,0,	 6,0,1,0},	// SBCD.B Dn,Dn
/*1888*/	{2,	1,	19,2,0,1,	22,2,1,1},	// SBCD.B -(An),-(An)
/*1889*/	{0,	0,	 4,0,0,0,	 6,0,1,0},	// ABCD.B Dn,Dn
/*1890*/	{2,	1,	19,2,0,1,	22,2,1,1}	// ABCD.B -(An),-(An)
};
