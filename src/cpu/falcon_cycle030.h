...
struct table_falcon_cycles_t table_falcon_cycles [] = {
	...
	{0,	1,	11,1,0,0,	13,1,1,0},	// AND.L (d16,An),Dn
	{2,	2,	12,1,0,0,	14,1,1,0},	// AND.L (d8,An,Xn),Dn
	{2,	2,	12,1,0,0,	16,1,2,0},	// AND.L (xxx).W,Dn
	{4,	2,	14,1,0,0,	18,1,2,0},	// AND.L (xxx).L,Dn
	{2,	2,	12,1,0,0,	16,1,2,0},	// AND.L (d16,PC),Dn
	{1,	0,	12,1,0,0,	17,1,2,0},	// AND.L (d8,PC,Xn),Dn
	{2,	2,	12,1,0,0,	16,1,2,0},	// AND.L #<data>.L,Dn
	{4,	2,	14,1,0,0,	18,1,2,0},	// MULU.W Dn,Dn
	{4,	0,	 6,0,0,0,	10,0,2,0},	// MULU.W (An),Dn
	{},	// MULU.W (An)+,Dn
	{},	// MULU.W -(An),Dn
	{},	// MULU.W (d16,An),Dn
	{},	// MULU.W (d8,An,Xn),Dn
