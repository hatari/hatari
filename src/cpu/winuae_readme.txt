		The CPU core in this directory is based on
			WinUAE 3.1.0 b16 (18/04/2015)


To update to a newer WinUAE's version, a diff should be made between
WinUAE 3.1.0 b16 sources and the newer sources, then the resulting patch
...
top of this file to keep track of the reference version used for the CPU core.
