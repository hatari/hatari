...
static SGOBJ maindlg[] =
{
	...
	{ SGBUTTON, SG_SHORTCUT_KEY('B'), 0,  2, 4, 13,1, "A_bout" },
	{ SGBUTTON, SG_SHORTCUT_KEY('Y'), 0,  2, 6, 13,1, "S_ystem" },
	{ SGBUTTON, SG_SHORTCUT_KEY('R'), 0,  2, 8, 13,1, "_ROM" },
	{ SGBUTTON, SG_SHORTCUT_KEY('M'), 0,  2,10, 13,1, "_Memory" },
	{ SGBUTTON, SG_SHORTCUT_KEY('F'), 0, 17, 4, 16,1, "_Floppy disks" },
	{ SGBUTTON, SG_SHORTCUT_KEY('D'), 0, 17, 6, 16,1, "Hard _disks" },
	{ SGBUTTON, SG_SHORTCUT_KEY('A'), 0, 17, 8, 16,1, "_Atari screen" },
	{ SGBUTTON, SG_SHORTCUT_KEY('H'), 0, 17,10, 16,1, "_Hatari screen" },
	{ SGBUTTON, SG_SHORTCUT_KEY('J'), 0, 35, 4, 13,1, "_Joysticks" },
	{ SGBUTTON, SG_SHORTCUT_KEY('K'), 0, 35, 6, 13,1, "_Keyboard" },
	{ SGBUTTON, SG_SHORTCUT_KEY('E'), 0, 35, 8, 13,1, "D_evices" },
	...
	{ SGRADIOBUT, SG_SHORTCUT_KEY('N'), 0, 3,15, 10,1, "_No Reset" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('C'), 0, 3,17, 15,1, "Reset ma_chine" },
	{ SGBUTTON, SG_DEFAULT, 0, 21,15, 8,3, "OK" },
	{ SGBUTTON, SG_SHORTCUT_KEY('Q'), 0, 36,15, 10,1, "_Quit" },
