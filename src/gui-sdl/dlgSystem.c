...
static SGOBJ systemdlg[] =
{
	...
	{ SGRADIOBUT, SG_SHORTCUT_KEY('S'), 0, 3,5, 4,1, "_ST" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('E'), 0, 3,6, 5,1, "ST_E" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('T'), 0, 3,7, 4,1, "_TT" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('F'), 0, 3,8, 8,1, "_Falcon" },

	{ SGBOX, 0, 0, 17,3, 13,8, NULL },
	{ SGTEXT, 0, 0, 19,3, 8,1, "CPU type" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('0'), 0, 19, 5, 7,1, "680_00" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('1'), 0, 19, 6, 7,1, "680_10" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('2'), 0, 19, 7, 7,1, "680_20" },
#ifdef ENABLE_WINUAE_CPU
	{ SGRADIOBUT, SG_SHORTCUT_KEY('3'), 0, 19, 8, 7,1, "680_30" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('4'), 0, 19, 9, 7,1, "680_40" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('9'), 0, 19,10, 7,1, "68060" },
#else
	{ SGRADIOBUT, SG_SHORTCUT_KEY('3'), 0, 19, 8,11,1, "680_30+FPU" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('4'), 0, 19, 9, 7,1, "680_40" },
	...
	{ SGRADIOBUT, SG_SHORTCUT_KEY('8'), 0, 32,5, 8,1, " _8 Mhz" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('6'), 0, 32,6, 8,1, "1_6 Mhz" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('M'), 0, 32,7, 8,1, "32 _Mhz" },

	{ SGBOX, 0, 0, 44,3, 14,8, NULL },
	{ SGTEXT, 0, 0, 45,3, 11,1, "Falcon DSP" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('N'), 0, 45,5, 6,1, "_None" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('Y'), 0, 45,6, 7,1, "Dumm_y" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('L'), 0, 45,7, 6,1, "Ful_l" },
	...
	{ SGCHECKBOX, SG_SHORTCUT_KEY('R'), 0, 3,14, 27,1, "_Real time clock emulation" },
	{ SGCHECKBOX, SG_SHORTCUT_KEY('B'), 0, 3,15, 19,1, "_Blitter emulation" },
	{ SGCHECKBOX, SG_SHORTCUT_KEY('D'), 0, 3,16, 15,1, "Patch Timer-_D" },
	{ SGCHECKBOX, SG_SHORTCUT_KEY('P'), 0, 3,17, 39,1, "Boot faster by _patching TOS & sysvars" },
	{ SGCHECKBOX, SG_SHORTCUT_KEY('H'), 0, 3,18, 23,1, "Prefetc_h mode, slower" },
#ifdef ENABLE_WINUAE_CPU
	{ SGCHECKBOX, SG_SHORTCUT_KEY('X'), 0, 3,19, 22,1, "Cycle e_xact, slower" },
	{ SGCHECKBOX, SG_SHORTCUT_KEY('U'), 0, 3,20, 15,1, "MM_U emulation" },
	{ SGCHECKBOX, SG_SHORTCUT_KEY('G'), 0, 3,21, 21,1, "24 bits addressin_g" },
#else
	{ SGTEXT, 0, 0, 3,19, 1,1, "" },
	{ SGTEXT, 0, 0, 3,20, 1,1, "" },
	{ SGTEXT, 0, 0, 3,21, 1,1, "" },
	...
	{ SGRADIOBUT, SG_SHORTCUT_KEY('O'), 0, 45,14, 6,1, "N_one" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('5'), 0, 45,15, 7,1, "68881" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('7'), 0, 45,16, 7,1, "68882" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('I'), 0, 45,17, 14,1, "_internal" },
	{ SGCHECKBOX, SG_SHORTCUT_KEY('C'), 0, 45,19, 25,1, "_compatible" },
