...
static SGOBJ monitordlg[] =
{
	...
	{ SGRADIOBUT, 0, 0, 12,3,  5,1, "RGB" },
	{ SGRADIOBUT, 0, 0, 19,3,  5,1, "VGA" },
	{ SGRADIOBUT, 0, 0, 26,3,  4,1, "TV" },
	{ SGCHECKBOX, 0, 0, 12,5, 14,1, "Show borders" },

	{ SGBOX,      0, 0,  1,8, 32,7, NULL },
	{ SGCHECKBOX, 0, 0,  4,9, 25,1, "Use extended VDI screen" },
...
static SGOBJ windowdlg[] =
{
	...
	{ SGRADIOBUT, 0, 0,  6,9,  6,1, "None" },
	{ SGTEXT,     0, 0, 19,4, 12,1, "Frame skip:" },
	{ SGRADIOBUT, 0, 0, 21,5,  5,1, "Off" },
	{ SGRADIOBUT, 0, 0, 21,6,  3,1, "1" },
	{ SGRADIOBUT, 0, 0, 21,7,  3,1, "2" },
	{ SGRADIOBUT, 0, 0, 21,8,  3,1, "4" },
	{ SGRADIOBUT, 0, 0, 21,9,  6,1, "Auto" },
	{ SGTEXT,     0, 0, 33,2, 14,1, "Keep desktop" },
	{ SGTEXT,     0, 0, 33,3, 14,1, "resolution:" },
	{ SGCHECKBOX, 0, 0, 35,4,  8,1, "ST/STe" },
	{ SGCHECKBOX, 0, 0, 35,5, 11,1, "TT/Falcon" },
