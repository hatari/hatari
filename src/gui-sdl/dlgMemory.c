...
static SGOBJ memorydlg[] =
{
	...
	{ SGRADIOBUT, SG_SHORTCUT_KEY('5'), 0, 18,4, 9,1, "_512 KiB" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('1'), 0, 18,5, 7,1, "_1 MiB" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('2'), 0, 18,6, 7,1, "_2 MiB" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('4'), 0, 29,4, 7,1, "_4 MiB" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('8'), 0, 29,5, 7,1, "_8 MiB" },
	{ SGRADIOBUT, SG_SHORTCUT_KEY('M'), 0, 29,6, 8,1, "14 _MiB" },
	...
	{ SGBUTTON,   SG_SHORTCUT_KEY('S'), 0,  8,15, 10,1, "_Save" },
	{ SGBUTTON,   SG_SHORTCUT_KEY('R'), 0, 22,15, 10,1, "_Restore" },
	{ SGCHECKBOX, SG_SHORTCUT_KEY('L'), 0,  2,17, 34,1, "_Load/save state at start-up/exit" },
