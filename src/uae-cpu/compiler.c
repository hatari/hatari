...
static uae_u32 testmask = 0xFC0000, testval = 0xFC0000;

#ifndef USER_PROGRAMS_BEHAVE
...
static int m68k_compile_block(struct hash_block *hb)
{
    ...
    if ((hb->he_first->addr & 0xFC0000) != 0xFC0000
	&& 0 && !patched_syscalls)
	return 1;

    exits_necessary = ((hb->he_first->addr & 0xFC0000) == 0xFC0000 || !USER_PROGRAMS_BEHAVE);
